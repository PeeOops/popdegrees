    ...
    return(
        <div className="flex flex-row">
            <div className="bg-white h-screen w-1/3 p-8">
                ...
                <img src={Venom} alt="" className="rounded-lg 2xl:w-96 lg:w-80 m-auto"/>
            </div>
            <div className="bg-red-950 h-screen w-2/3 p-8 text-white montserrat overflow-x-hidden">
                <div className="flex space-x-80 items-center flex-row">
                    <h1 className="2xl:text-4xl lg:text-2xl font-bold">Venom: The Last Dance (2024)</h1>
                ...
                <p className="2xl:text-md lg:text-sm">Eddie and Venom are on the run. Hunted by both of their worlds and with the net closing in, the duo are forced into a devastating decision that will bring the curtains down on Venom and Eddie's last dance.</p>
